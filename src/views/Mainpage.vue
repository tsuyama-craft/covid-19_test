...
export default {
  ...
  mounted: function() {
    ...
    this.get_csv("https://tsuyama-craft.github.io/covid-19_test/data/pcr.csv",true,'SJIS','UNICODE', this.setKenPcr); 
    ...
    this.get_csv("https://tsuyama-craft.github.io/covid-19_test/data/kanjahasseijoukyou.csv",true,'SJIS','UNICODE',  this.setKenDead);
    this.get_csv("https://tsuyama-craft.github.io/covid-19_test/data/330001okayamacovid19medicalsystem.csv",true,'SJIS','UNICODE',  this.setKenIryou);
