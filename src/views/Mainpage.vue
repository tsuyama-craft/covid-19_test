...
export default {
  ...
  mounted: function() {
    this.get_csv("https://tsuyama-craft.github.io/covid-19_test/data/kansenshasuu0420.csv",true,'SJIS','UNICODE', this.setKenDetails);
    this.get_csv("https://tsuyama-craft.github.io/covid-19_test/data/pcr.csv",true,'UTF8','UNICODE', this.setKenPcr); 
    this.get_csv("https://tsuyama-craft.github.io/covid-19_test/data/kansenshashousaijouhou.csv",true,'SJIS','UNICODE',  this.setKenUchiwake);
    this.get_csv("https://tsuyama-craft.github.io/covid-19_test/data/kanjahasseijoukyou.csv",true,'UTF8','UNICODE',  this.setKenDead);
    this.get_csv("https://tsuyama-craft.github.io/covid-19_test/data/330001okayamacovid19medicalsystem.csv",true,'UTF8','UNICODE',  this.setKenIryou);
