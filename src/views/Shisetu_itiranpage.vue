  ...
  mounted: function() {
    switch(this.location_no){
      ...
      case '3':
        ...
        break;
      case '4':
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/Sports_location.csv",true,'UTF8','UNICODE',this.setSports);
        break;
      case '5':
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/Nursery_location.csv",true,'UTF8','UNICODE',this.setNursery);
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/Kindergarten_location.csv",true,'UTF8','UNICODE',this.setKind);
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/JuniorSchool_location.csv",true,'UTF8','UNICODE',this.setJunior);
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/JuniorHighSchool_location.csv",true,'UTF8','UNICODE',this.setJuniorHigh);
        break;
      case '6':
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/Sightseeing_location.csv",true,'UTF8','UNICODE',this.setSight);
        break;
      case '7':
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/Welfare_location.csv",true,'UTF8','UNICODE',this.setWelfare);
        break;
      case '8':
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/Park_location.csv",true,'UTF8','UNICODE',this.setPark);
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/Library_location.csv",true,'UTF8','UNICODE',this.setLibrary);
        break;
      case '9':
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/Government_location.csv",true,'UTF8','UNICODE',this.setGovernment);
        break;
      case '10':
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/Rally_location.csv",true,'UTF8','UNICODE',this.setRally);
        break;
      case '11':
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/Children_location.csv",true,'UTF8','UNICODE',this.setChild);
        break;
      case '12':
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/AED_location.csv",true,'UTF8','UNICODE',this.setAED);
        break;
      default:
        break;
    }
