...
export default {
  ...
  mounted: function() {
    switch(this.location_no){
      case '1':
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/Okayama_iryou.csv",true,'UTF8','UNICODE',this.setIryou);
        break;
      case '2':
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/Okayama_shika.csv",true,'UTF8','UNICODE',this.setShika);
        break;
      case '3':
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/Okayama_yakkyoku.csv",true,'UTF8','UNICODE',this.setYakkyoku);
        break;
      case '4':
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/Sports_location.csv",true,'SJIS','UNICODE',this.setSports);
        break;
      case '5':
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/Nursery_location.csv",true,'SJIS','UNICODE',this.setNursery);
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/Kindergarten_location.csv",true,'SJIS','UNICODE',this.setKind);
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/JuniorSchool_location.csv",true,'SJIS','UNICODE',this.setJunior);
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/JuniorHighSchool_location.csv",true,'SJIS','UNICODE',this.setJuniorHigh);
        break;
      case '6':
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/Sightseeing_location.csv",true,'SJIS','UNICODE',this.setSight);
        break;
      case '7':
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/Welfare_location.csv",true,'SJIS','UNICODE',this.setWelfare);
        break;
      case '8':
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/Park_location.csv",true,'SJIS','UNICODE',this.setPark);
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/Library_location.csv",true,'SJIS','UNICODE',this.setLibrary);
        break;
      case '9':
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/Government_location.csv",true,'SJIS','UNICODE',this.setGovernment);
        break;
      case '10':
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/Rally_location.csv",true,'SJIS','UNICODE',this.setRally);
        break;
      case '11':
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/Children_location.csv",true,'SJIS','UNICODE',this.setChild);
        break;
      case '12':
        this.GetCsvFile("https://tsuyama-craft.github.io/covid-19_test/data/AED_location.csv",true,'SJIS','UNICODE',this.setAED);
        break;
      default:
        break;
    }
